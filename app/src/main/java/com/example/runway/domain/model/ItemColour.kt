...
enum class ItemColour(val label: String, val argb: Int) {
    WHITE("White", 0xFFFFFFFF.toInt()),
    CREAM("Cream", 0xFFF5EFE0.toInt()),
    BEIGE("Beige", 0xFFE3D5B8.toInt()),
    TAUPE("Taupe", 0xFFB8A894.toInt()),
    TAN("Tan", 0xFFC08A4E.toInt()),
    CAMEL("Camel", 0xFFA9743B.toInt()),
    BROWN("Brown", 0xFF6B4423.toInt()),
    BLACK("Black", 0xFF101010.toInt()),
    CHARCOAL("Charcoal", 0xFF3A3E43.toInt()),
    GREY("Grey", 0xFF9AA0A6.toInt()),
